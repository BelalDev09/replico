...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form" method="POST" action="{{ route('admin.system.settingupdate') }}"
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" class="form-control"
                                        value="{{ $setting->system_short_title ?? '' }}" placeholder="System title"
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="tag_line" class="form-control"
                                        value="{{ $setting->tag_line ?? '' }}" placeholder="Tag" name="tag_line" />
                                    @error('tag_line')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="custom-select select2-size-lg" id="country-code" name="phone_code">
                                            <option value="+1" {{ $setting?->phone_code === '+1' ? 'selected' : '' }}>
                                                +1
                                                (USA)
                                            </option>
                                            <option value="+1" {{ $setting?->phone_code === '+1' ? 'selected' : '' }}>
                                                +1
                                                (Canada)</option>
                                            <option value="+44" {{ $setting?->phone_code === '+44' ? 'selected' : '' }}>
                                                +44
                                                (United Kingdom)</option>
                                            <option value="+91" {{ $setting?->phone_code === '+91' ? 'selected' : '' }}>
                                                +91
                                                (India)</option>
                                            <option value="+61" {{ $setting?->phone_code === '+61' ? 'selected' : '' }}>
                                                +61
                                                (Australia)</option>
                                            <option value="+81" {{ $setting?->phone_code === '+81' ? 'selected' : '' }}>
                                                +81
                                                (Japan)</option>
                                            <option value="+49" {{ $setting?->phone_code === '+49' ? 'selected' : '' }}>
                                                +49
                                                (Germany)</option>
                                            <option value="+33" {{ $setting?->phone_code === '+33' ? 'selected' : '' }}>
                                                +33
                                                (France)</option>
                                            <option value="+34" {{ $setting?->phone_code === '+34' ? 'selected' : '' }}>
                                                +34
                                                (Spain)</option>
                                            <option value="+39" {{ $setting?->phone_code === '+39' ? 'selected' : '' }}>
                                                +39
                                                (Italy)</option>
                                            <option value="+55" {{ $setting?->phone_code === '+55' ? 'selected' : '' }}>
                                                +55
                                                (Brazil)</option>
                                            <option value="+7" {{ $setting?->phone_code === '+7' ? 'selected' : '' }}>
                                                +7
                                                (Russia)</option>
                                            <option value="+86" {{ $setting?->phone_code === '+86' ? 'selected' : '' }}>
                                                +86
                                                (China)</option>
                                            <option value="+91" {{ $setting?->phone_code === '+91' ? 'selected' : '' }}>
                                                +91
                                                (India)</option>
                                            <option value="+62" {{ $setting?->phone_code === '+62' ? 'selected' : '' }}>
                                                +62
                                                (Indonesia)</option>
                                            <option value="+971"
                                            ...
                                            <option value="+52" {{ $setting?->phone_code === '+52' ? 'selected' : '' }}>
                                                +52
                                                (Mexico)</option>
                                            <option value="+20" {{ $setting?->phone_code === '+20' ? 'selected' : '' }}>
                                                +20
                                                (Egypt)</option>
                                            <option value="+27" {{ $setting?->phone_code === '+27' ? 'selected' : '' }}>
                                                +27
                                                (South Africa)</option>
                                            <option value="+66" {{ $setting?->phone_code === '+66' ? 'selected' : '' }}>
                                                +66
                                                (Thailand)</option>
                                            <option value="+63" {{ $setting?->phone_code === '+63' ? 'selected' : '' }}>
                                                +63
                                                (Philippines)</option>
                                            <option value="+55" {{ $setting?->phone_code === '+55' ? 'selected' : '' }}>
                                                +55
                                                (Brazil)</option>
                                            <option value="+98" {{ $setting?->phone_code === '+98' ? 'selected' : '' }}>
                                                +98
                                                (Iran)</option>
                                            <option value="+90" {{ $setting?->phone_code === '+90' ? 'selected' : '' }}>
                                                +90
                                                (Turkey)</option>
                                            <option value="+82" {{ $setting?->phone_code === '+82' ? 'selected' : '' }}>
                                                +82
                                                (South Korea)</option>
                                            <option value="+34" {{ $setting?->phone_code === '+34' ? 'selected' : '' }}>
                                                +34
                                                (Spain)</option>
                                            <option value="+32" {{ $setting?->phone_code === '+32' ? 'selected' : '' }}>
                                                +32
                                                (Belgium)</option>
                                            <option value="+31"
